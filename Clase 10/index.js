...
localStorage.setItem("arreglo", [1,2,3,4,5]); // convierte todo en string y guarda de forma local */

/* let nombre = localStorage.getItem("nombre");
console.log(nombre);

sessionStorage.setItem("edad", 50); // es info de sesion, si se cierra el navegador se pierde info */

//RECORRER CON FOR LA INFO
...
//ELIMINAR CARRITO CON LA INFO EN LOCALSTORE
/* const productos = [
  { id: 1, nombre: "camisa", precio: 1000 },
  { id: 2, nombre: "pantalon", precio: 1000 },
  { id: 3, nombre: "zapato", precio: 1000 },
